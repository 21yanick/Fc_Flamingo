  ...
  return (
    <section id="triumph" className="py-20 bg-training-bg dark:bg-matchday-bg">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-2xl font-bold mb-8">Wird das deine Geschichte?</p>

        <p className="text-3xl font-bold text-primary italic mb-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="aspect-video bg-muted/30 rounded-lg flex items-center justify-center">
            <p className="text-sm text-muted-foreground">
              TODO: K13-1.jpg (Konfetti + Pokal + Jubel - Emotional Peak!)
            </p>
          </div>
        </div>
      </div>
