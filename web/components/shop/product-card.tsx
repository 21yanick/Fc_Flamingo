...
import { formatSwissPrice, type Product } from "@/lib/shop/product-types"
...
export function ProductCard({ product, className }: ProductCardProps) {
  ...
  const handleAddToCart = () => {
    ...
    const cartProduct = {
      ...
      name: product.name,
      price: product.price,
      image_url: product.image_url || undefined, // Convert null to undefined for cart compatibility
  ...
  return (
    <Card className={`group hover:shadow-lg transition-all duration-300 ${className || ""}`}>
      ...
      <CardContent className="p-6">
        ...
        {/* Add to Cart Button */}
        <Button onClick={handleAddToCart} className="w-full group/button" size="lg">
