...
export function OrderStatusEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Bestellung #{shortOrderId} - {statusLabel}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          {newStatus === "shipped" && hasShipping && (
            <Section style={infoSection}>
              <Text style={text}>
                ...
                <br />
                Ihre Bestellung ist unterwegs und sollte in den nächsten 1-3 Werktagen bei Ihnen
                ankommen.
                {trackingNumber &&
                  " Sie können den Versandstatus mit der oben angegebenen Sendungsnummer verfolgen."}
              </Text>
            </Section>
          )}
          ...
          {newStatus === "completed" && (
            <Section style={infoSection}>
              <Text style={text}>
                <strong>Vielen Dank für Ihren Einkauf!</strong>
                <br />
                {hasShipping
